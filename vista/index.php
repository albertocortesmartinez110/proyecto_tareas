        ...
        $(document).ready(function (){  //funcion para inciar scripts despues de haberse cargado la pagina
            ...
            $.ajax({
                ...
                for (var i=0; i<datos.length;i++){
                    $(".contenido").append("<div>"+datos[i]['id_tarea']+"</div><div>"+datos[i]['id_usuario']+"</div>" +
            ...
            $.ajax({
                ...
                for (var i=0; i<datos.length;i++){
                    ...
                    alert("vaya parece que no tienes nada pendiente");
                }
            });
            ...
            $("#editar_tarea").click(function (e){
                e.preventDefault();
                var datos ={id_editar_tarea:$("#id_tarea_editar").val(),
